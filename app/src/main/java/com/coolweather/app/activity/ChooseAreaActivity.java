...
/**
 * Created by Jiang Meng on 2016/7/26.
 */
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int index, long id) {
                if (currentLevel == LEVEL_PROVINCE) {
                    ...
                    queryCities();
//                    Toast.makeText(ChooseAreaActivity.this,selectedProvince.toString(), Toast.LENGTH_SHORT).show();
                }else if(currentLevel == LEVEL_CITY){
                    seletedCity = cityList.get(index);
                    queryCounties();
//                    Toast.makeText(ChooseAreaActivity.this,seletedCity.toString(), Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(ChooseAreaActivity.this,"1", Toast.LENGTH_SHORT).show();
                    result = Utility.handleProvinceResponse(coolWeatherDB,response);
                }else if("city".equals(type)){
//                    Toast.makeText(ChooseAreaActivity.this,"2", Toast.LENGTH_SHORT).show();
                    result = Utility.handleCitiesResponse(coolWeatherDB,response,selectedProvince.getId());
                }else if("county".equals(type)){
//                    Toast.makeText(ChooseAreaActivity.this,"3", Toast.LENGTH_SHORT).show();
                    result = Utility.handleCountiesResponse(coolWeatherDB,response,seletedCity.getId());
                }
//                Toast.makeText(ChooseAreaActivity.this,"4", Toast.LENGTH_SHORT).show();
                if(result){
